...
# 1. Load dataset
# ------------------------
df = pd.read_csv("../Dataset/Health_Quality_Dataset.csv")
...
# Save Random Forest
joblib.dump(rf_model, "../models/rf_health_model.pkl")

# Save XGBoost
joblib.dump(xgb_model, "../models/xgb_health_model.pkl")

# Save LightGBM
joblib.dump(lgb_model, "../models/lgb_health_model.pkl")
